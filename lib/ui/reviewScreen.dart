                                  ...
                                  return Padding(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        RatingBar.builder(
                                          initialRating:reviewAttribute[reviewAttributeList[index].id] is int?double.parse(reviewAttribute[reviewAttributeList[index].id].toString()):reviewAttribute[reviewAttributeList[index].id] ?? 0.0,
                                          minRating: 1,
                                          direction: Axis.horizontal,
                                          allowHalfRating: true,
                                          itemCount: 5,
