                ...
                if (MyAppState.currentUser!.vendorID.isNotEmpty) {
                  if (MyAppState.currentUser!.userBankDetails.accountNumber.isNotEmpty){
                    ...
                    final snackBar = SnackBar(
                      ...
                      content: const Text('Please add your Bank Details first',).tr(),
                    );
                  ...
                  final snackBar = SnackBar(
                    backgroundColor: Colors.red[400],
                    content: const Text('Please add your Store first',).tr(),
                  );
                  ScaffoldMessenger.of(context).showSnackBar(snackBar);
                }
    ...
    FireStoreUtils.createPaymentId(collectionName: Payouts).then((value) {
      ...
      FireStoreUtils.withdrawWalletAmount(withdrawHistory: withdrawHistory)
        ...
        FireStoreUtils.updateWalletAmount(
            userId: userId,
            amount: -double.parse(_amountController.text)).whenComplete(() {
